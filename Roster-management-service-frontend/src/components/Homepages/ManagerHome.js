...
function ManagerHome() {
    ...
    const handleCreateUser = async () => {
        try {
            await axios.post('http://localhost:8084/api/signUp', formData);
            setFormData({
                username: '',
                email: '',
                password: '',
    ...
    const handleUpdateUser = async () => {
        try {
            await axios.post(`http://localhost:8084/api/updateUser/${selectedUserId}`, formData);
            setFormData({
                username: '',
                email: '',
                password: '',
    ...
    const handleAddRoster = async () => {
        try {
            await axios.post('http://localhost:8084/api/addRoster', rosterFormData);
            setRosterFormData({
                empid: '',
                date: '',
                drivername: '',
